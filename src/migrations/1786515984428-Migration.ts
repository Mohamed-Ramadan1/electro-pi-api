...
export class Migration1786515984428 implements MigrationInterface {
    name = 'Migration1786515984428'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "reminders" ADD "queued" boolean NOT NULL DEFAULT false`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "reminders" DROP COLUMN "queued"`);
    }
