...
export class Migration1785884980457 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."reminders_repeatinterval_enum" AS ENUM('none', 'daily', 'weekly', 'monthly', 'custom')`,
    );
    await queryRunner.query(
      `CREATE TABLE "reminders" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "isActive" boolean NOT NULL DEFAULT true, "title" character varying(150) NOT NULL, "reminderMessage" text NOT NULL, "reminderAt" TIMESTAMP WITH TIME ZONE NOT NULL, "repeatCount" integer DEFAULT '1', "snoozeMinutes" integer, "repeatInterval" "public"."reminders_repeatinterval_enum" NOT NULL DEFAULT 'none', "isSent" boolean NOT NULL DEFAULT false, "isCompleted" boolean NOT NULL DEFAULT false, "nextTriggerAt" TIMESTAMP WITH TIME ZONE, "user_id" uuid NOT NULL, CONSTRAINT "PK_38715fec7f634b72c6cf7ea4893" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_b58a50ed8f58969e3ad4062ffd" ON "reminders"  ("isActive") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_b667ee80edea71740fe69987a2" ON "reminders"  ("reminderAt", "isSent") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b667ee80edea71740fe69987a2"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b58a50ed8f58969e3ad4062ffd"`,
    );
    await queryRunner.query(`DROP TABLE "reminders"`);
    await queryRunner.query(
      `DROP TYPE "public"."reminders_repeatinterval_enum"`,
    );
    await queryRunner.query(
