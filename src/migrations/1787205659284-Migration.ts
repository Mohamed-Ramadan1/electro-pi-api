...
export class Migration1787205659284 implements MigrationInterface {
  name = 'Migration1787205659284';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "team_members" ADD "creator_id" uuid NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "team_projects" DROP CONSTRAINT "FK_e5b9a92aa740f36adade8dc1036"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "team_projects" DROP CONSTRAINT "FK_babf5e141982a779d3f778de572"`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "team_members" DROP COLUMN "creator_id"`,
    );
  }
}
