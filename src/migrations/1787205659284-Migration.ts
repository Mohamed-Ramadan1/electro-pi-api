...
export class Migration1787205659284 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "team_members" ADD "creator_id" uuid NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "team_members" ADD CONSTRAINT "FK_1a947faf03c819d736cad655ac8" FOREIGN KEY ("creator_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "projects" DROP CONSTRAINT "FK_4b86fad39217ca10aace123c7bd"`);
        await queryRunner.query(`ALTER TABLE "teams" DROP CONSTRAINT "FK_42744d21c558ffeb2b57a1f6a1a"`);
        await queryRunner.query(`ALTER TABLE "team_members" DROP CONSTRAINT "FK_1a947faf03c819d736cad655ac8"`);
        await queryRunner.query(`ALTER TABLE "team_members" DROP CONSTRAINT "FK_c2bf4967c8c2a6b845dadfbf3d4"`);
        await queryRunner.query(`ALTER TABLE "team_members" DROP CONSTRAINT "FK_fdad7d5768277e60c40e01cdcea"`);
        await queryRunner.query(`ALTER TABLE "notifications" DROP CONSTRAINT "FK_9a8a82462cab47c73d25f49261f"`);
        await queryRunner.query(`ALTER TABLE "notes" ALTER COLUMN "id" DROP DEFAULT`);
        ...
        await queryRunner.query(`ALTER TABLE "team_members" DROP COLUMN "creator_id"`);
    }
