...
export class Migration1785599658233 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "notes" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "isActive" boolean NOT NULL DEFAULT true, "title" character varying(255) NOT NULL, "content" text, "imageKey" character varying(500), "imageUrl" character varying(2000), "user_id" uuid NOT NULL, CONSTRAINT "PK_af6206538ea96c4e77e9f400c3d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_4b2df75d5fc70dea461000ad7a" ON "notes"  ("isActive") `,
    );
    await queryRunner.query(
      `ALTER TABLE "task_images" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "task_images" ADD "isActive" boolean NOT NULL DEFAULT true`,
    );
    await queryRunner.query(
      `ALTER TABLE "tasks" ADD "isActive" boolean NOT NULL DEFAULT true`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_ec0a96740c7663ca8dd3618885" ON "task_images"  ("isActive") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_ec0a96740c7663ca8dd3618885"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ALTER COLUMN "id" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "task_images" DROP COLUMN "updatedAt"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_4b2df75d5fc70dea461000ad7a"`,
    );
    await queryRunner.query(`DROP TABLE "notes"`);
    await queryRunner.query(
      `CREATE INDEX "IDX_c300d154a85801889174e92a3d" ON "tasks" USING btree ("dueDate") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_bd213ab7fa55f02309c5f23bbc" ON "tasks" USING btree ("priority") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_6086c8dafbae729a930c04d865" ON "tasks" USING btree ("status") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_5cdbaf4fa40456d134f78e5d30" ON "projects" USING btree ("projectStatus") `,
    );
  }
}
